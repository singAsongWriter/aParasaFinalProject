            ...
            <div class="container">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            <div class="col-lg-5 col-md-6 m-3 border border-primary" >
                                <div>
                                    <div class="position-relative overflow-hidden">
                                    	<img class="img-fluid" src="img/property-1.jpg" alt="">
                                    </div>
                                    <div class="p-4 pb-0">
                                        <h5 class="text-primary mb-3 ">\1,000 할인</h5>
                            ...
                            <div class="col-lg-5 col-md-6 m-3 border border-primary" >
                                <div>
                                    ...
                                    <div class="p-4 pb-0">
                                        <h5 class="text-primary mb-3 ">\2,000 할인</h5>
                                        <span class="d-block h5 mb-2">상품명을 입력해주세요.</span>
                                        <span class="d-block mb-2">할인기간</span>
                                        <button type="button" class="btn btn-primary mb-2">삭제</button>
                                    </div>
                            ...
                            <div class="col-lg-5 col-md-6 m-3 border border-primary" >
                                <div>
                                    ...
                                    <div class="p-4 pb-0">
                                        <h5 class="text-primary mb-3 ">\3,000 할인</h5>
                                        <span class="d-block h5 mb-2">상품명을 입력해주세요.</span>
                                        <span class="d-block mb-2">할인기간</span>
                                        <button type="button" class="btn btn-primary mb-2">삭제</button>
                                    </div>
